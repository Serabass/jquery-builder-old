var JQueryBuilder = (function () {
    function initjQuery (initCallback) {
        return (function () {
             ...
             */
            jQuery.fn.join = function (delimiter, cb) {
             ...
             * @returns {*}
             */
            jQuery.fn.pop = function (cb) {
                var result = Parent.pop.call(this);
                if (typeof cb !== 'undefined') {
                    cb(result);
                    return this;
                }
             ...
             * @returns {jQuery.fn|Number}
             */
            jQuery.fn.count = function(filter, cb) {
                var result = 0;
             ...
             * @returns {*}
             */
            jQuery.fn.el = function (index, value, cb) {
                if (typeof value === 'undefined') {
                    return this.get(index, cb);
                }
             ...
             */
            jQuery.fn.toArray = function (cb) {
                var result = [];
                this.each(function () {
                    result.push(jQuery.value(this));
                });
                if (typeof cb !== 'undefined') {
                    cb(result);
                    return this;
    ...
    JQueryBuilder.simple = function (array) {
        var builder = new JQueryBuilder(function (selector, context) {
            ...
            for(var i = 0; i < context.length; i++) {
                var el = context[i];
                if (builder.match(selector, el, i)) {
                    this.push(el);
                }
            }
        });
         ...
         * # Написать доку
         */
        builder.match = function (selector, el, i) {
